			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="index_pengajuan_hrd.php">Data Pengajuan <span
				...
				<div class="row">
					...
					<div class="col-md-8 col-md-offset-2">
						...
						<form action="proses_search_pgj.php" method="get">
							...
							<button action="proses_search_pgj.php" type="submit" class="btn btn-primary"><i
									class="glyphicon glyphicon-search" value="Cari"></i> Cari</button>
						</form>
												...
												<?php
													...
													if($data['notif_pgj'] == 'Proses'){?>
														<a onclick=" cek(<?php echo $data['id_pengajuan']?>);" class="btn btn-info btn-xs"><i "></i>Konfirmasi </a>
											 			<a href=" proses_pengajuan.php?id_pengajuan=<?php echo $data['id_pengajuan']?>&action=Tolak"
															class="btn btn-danger btn-xs"><i class="glyphicon "></i>
															Tolak</a>
												<?php }?>
											</td>
										</tr>
