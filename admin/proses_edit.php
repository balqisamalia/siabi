...
$update	= mysqli_query($connect, "UPDATE barang SET kode_brg = '$kode_brg', nm_brg = '$nm_brg', nm_kantor = '$nm_kantor', jml_brg = '$jml_brg', hrg_brg = '$hrg_brg' , status_brg = '$status_brg' WHERE id_brg = '$id_brg'");
