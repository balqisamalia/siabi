...
$input		= mysqli_query($connect, "INSERT INTO barang (kode_brg, tgl_msk, nm_brg, nm_kantor, jml_brg, sat_brg, hrg_brg, tot_hrg, status_brg) VALUES ('$kode_brg','$tgl_msk', '$nm_brg', '$nm_kantor', 
	'$jml_brg' , '$sat_brg' , '$hrg_brg',$tot_hrg, '$status_brg')");
